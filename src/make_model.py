...
Conv = lambda num_filt,filt_size: Convolution2D(num_filt, filt_size, filt_size, dim_ordering = 'tf', border_mode = 'same', init = 'glorot_normal')
...
def make_net(num_classes):
	model = Sequential()
	model.add(Convolution2D(16, 5, 5, input_shape=(64,64,3), dim_ordering = 'tf', border_mode = 'same'))
